...
public class formattingXML extends Utilities{
		...
		public static void main(String[] args) throws Exception {
	        xmlWrite("CENDOC" , Thread.currentThread().getStackTrace()[1].getClassName(), "XML Folder" , "null" , "17/01/2017", "Saurabh");
			propertyFile();
			...
			for (int i = 0 ; i <FILE_LIST.get(0).size() ; i++) {
				...
				for(Object PropKey : PROP.keySet()){
					//System.out.println("Key of propry file = " + PropKey.toString());
		    	  ...
		    	  int temp = 0;
	//System.out.println(PropKey.toString()+nl.getLength());
